<?php 
    ...
    else
    {
        ...
        elseif($action == 'list'){
            ...
            $sql = "SELECT a.id , b.f_first_name AS retailer_name, a.name as customer_name, a.mobile_number, a.email,a.created_at as created_at 
                    FROM inv_customer a 
                    LEFT JOIN employees b ON a.retailer_id = b.f_id
