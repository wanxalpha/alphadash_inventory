                            ...
                            <?php  while($row = $result->fetch_assoc()) { ?>
                                                ...
                                                <tbody>
                                                    <?php $idx = 0; while($product = $resultProduct->fetch_assoc()) {  $idx += 1;?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="../../controller/refund.php?deleteProduct=<?php echo $product['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                ...
                                <div class="mt-4">
                                    ...
                                    <?php if($_SESSION['role'] == 'Master'){ ?>
                                        <a class="btn btn-warning me-2 float-right" href="../../controller/refund.php?validate=<?php echo $row['id']; ?>">Validate</a>
                                    <?php } ?>
                                </div>
                            <?php } ?>
                        </form>
