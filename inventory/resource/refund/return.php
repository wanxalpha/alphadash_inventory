...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header2">Edit Stock Return</h5>
                    <div class="card-body">
                            ...
                            <?php  while($row = $result->fetch_assoc()) { ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <input class="form-control" type="text" name="reference_number" id="reference_number" required readonly=true disabled=true value="<?php echo $row['reference_number']?>"/>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        autofocus required readonly=true disabled=true/>
                                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <a class="btn btn-warning me-2 float-right" href="../../controller/refund.php?retrieved=<?php echo $row['id']; ?>">Returned</a>
                                </div>
                            <?php } ?>
                        </form>
                    </div>
