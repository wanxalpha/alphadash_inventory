  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-12">
      ...
      <button class="btn btn-primary" id="btn_export_excel" >Export Excel</button>
        &nbsp;
        <a href="../stock_out/create.php" class="btn btn-primary">Add Stock Out</a>  
      </div>
    </div>
    <br>
    <div class="row">
        ...
        <div class="card">
          <div class="table-responsive text-nowrap">
            <table class="table table-striped">
              ...
              <tbody class="table-border-bottom-0" id="index_stock_out">
              </tbody>
            </table>
          </div>
        </div>
...
<script type="text/javascript" src="../../assets/js/resource/stock_out.js"> </script>