...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header2">Edit Stakeholder Category</h5>
                    <div class="card-body">

                        <form method="POST" action="../../controller/stakeholder_category.php" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="mb-12 col-md-12">
                                    ...
                                    <textarea type="text" class="form-control" id="remark" name="remark" ><?php echo $row['remark']?>
                                    </textarea>
                                </div>
                            </div>
