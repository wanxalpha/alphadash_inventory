...
$(document).on('click', ".stock_out_customer_delete", function (e) {
    // alert($(this).val());
    var json ={
        id :$(this).val() ,
        action:'delete'
...
$.get(url, { 
    ...
    .done(function (data) {
        ...
        if (data) {
            $('#index_stock_out_customer').html(data);

        } else {

            $('#index_stock_out_customer').html('<tr><td rowspan="4">No Data</td></tr>')
    ...
    function search(){
        ...
        .done(function (data) {
            ...
            if (data) {
                ...
                $('#index_stock_out_customer').html('<tr><td rowspan="5">No Data</td></tr>')
            }
        })
    }
