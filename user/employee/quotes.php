...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">Quotes & Proposal</h4>
    <div class="row mb-3">
      <div class="col-md-12">
        <div class="card">
          <h5 class="card-header2">Add Quotes & Proposal Details</h5>
          <div class="card-body">
            <form method="post" action="../controller/ajax/add_function/add_quotes.php">
              ...
              <!-- <div class="form-group row mb-3">
                <div class="col-sm-3">
                  <label for="qdate" class=" col-form-label  color-dark fs-14 fw-500 align-center">Date</label>
                </div>
                <div class="col-sm-9">
                  <input class="form-control" name="qdate" type="date" required>
                </div>
              </div> -->
              <div class="form-group row mb-3">
                <div class="col-sm-3">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="layout-button mt-25">
                    <button name="add_quotes" type="submit" class="btn btn-primary btn-default btn-squared px-30">Add Quotes/Proposal</button>
                  </div>
                </div>
              </div>
            </form>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Edit Quotes & Proposal</h5>
