...
$sql = "SELECT * FROM employees WHERE f_delete='N' AND f_full_name='$emp_id'";
$result = mysqli_query($conn, $sql);
$rows = mysqli_fetch_array($result);
$emp_code = $rows['f_emp_id'];

$query = "INSERT INTO claims (f_emp_id, f_claim_type, f_claim_info, f_claim_month, f_status, f_claim_amt, f_claim_date, f_created_date, f_modified_date) VALUES ('$emp_code', '$claim_type', '$claim_remarks', '$claim_month', 'Pending', '$claim_amt', '$claim_date', '$now', '$now')";
// echo $query; exit;
