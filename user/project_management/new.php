      ...
      <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-header2">NEW PROJECT DETAILS</h5>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                      <!-- <div class="info-box shadow" style="height: 80px;"> -->
                        <div class="info-box-content">
                          ...
                          <select id="prior" class="form-control select2" style="font-size:12px">
                  ...
                  <div class="row">
                    <div class="col-lg-2">
                      <input id="starDate" type="date" class="form-control select2" style="font-size:12px">
                    </div>
                    <div class="col-lg-2">
                      <input id="endDate" type="date" class="form-control select2" style="font-size:12px">
                    </div>
                  </div><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <select id="projectMana" class="form-control select2" style="font-size:12px">
                        ...
                        ?>
                        <option value="<?php echo $mkir?>"><?php echo $rowTeamDisplayA['f_name'];?></option>
                        <?php
                            $mkir++;
                          }
                        ?>
                      ...
                      <div class="row">
                        <div class="col-lg-8">
                          <select id="teamMem" class="form-control select2" style="font-size:12px">
                            ...
                            ?>
                            <option value="<?php echo $ret?>"><?php echo $rowTeamDisplay['f_name'];?></option>
                            <?php
                                  $ret++;
                                }
                            ?>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-5">
                      <textarea name="" id="proDesc" style="width: 100%;" rows="10"><?php echo $projectDetail?></textarea>
                    </div>
                    <!-- <div class="col-lg-3">
