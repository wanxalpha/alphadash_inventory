...
$newDate = date("Y-m-d", strtotime($birth_date));
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                        <a class="nav-link active" href="emp_pers_detail.php?emp_id=<?php echo $emp_id ?>"><i class="bx bx-user me-1"></i> Personal Info</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <div class="button-wrapper">
                                    <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                        ...
                                        <input type="file" id="picture_image" name="picture_image" class="account-file-input" accept="image/png, image/jpeg" />
                                    </label>
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                ...
                                <div class="col-6 mb-0">
                                    ...
                                    <!-- <input type="text" id="gender" name="gender" class="form-control" value="" /> -->
                                    <select required id="gender" name="gender" class="form-control select">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col mb-0">
                                    ...
                                    <input type="date" id="birthday" name="birthday" class="form-control" value="<?php echo $newDate ?>" />
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col mb-0">
                                    <label for="emailExLarge" class="form-label">Ic</label>
                                    <input type="text" id="identity" name="identity" class="form-control" value="<?php echo $identity ?>" />
                                </div>
                                <div class="col mb-0">
                                    <label for="formFile" class="form-label">Upload Ic Photo</label>
                            ...
                            <div class="row mb-4">
                                <div class="col mb-0">
                                    <label for="dobExLarge" class="form-label">Department</label>
                                    <div class="input-group">
                                        <select required id="department" name="department" class="form-control select">
                                            <?php
                                ...
                                <div class="col mb-0">
                                    <label for="dobExLarge" class="form-label">Designation</label>
                                    <div class="input-group">
                                        <select required id="designation" name="designation" class="form-control select">
                                            <option value="<?php echo $designation ?>"><?php echo $designation2 ?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4 mb-0">
                                    ...
                                    <select required name="race" id="race" class="form-control select">
                                        ...
                                        <option value="Malay" <?php if ($race == "Malay") {
                                                                    echo ' selected';
                                                                } ?>>Malay</option>
                                        <option value="Chinese" <?php if ($race == "Chinese") {
                                                                    echo ' selected';
                                                                } ?>>Chinese</option>
                                        <option value="Indian" <?php if ($race == "Indian") {
                                                                    echo ' selected';
                                                                } ?>>Indian</option>
                                        <option value="Others" <?php if ($race == "Others") {
                                                                    echo ' selected';
                                                                } ?>>Others</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-0">
                                    ...
                                    <select required name="religion" id="religion" class="form-control select">
                                        ...
                                        <option value="Atheist" <?php if ($religion == "Atheist") {
                                                                    echo ' selected';
                                                                } ?>>Atheist</option>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4 mb-0">
                                    ...
                                    <select class="select form-control" id="marital" name="marital" onchange="change_marital()">
                                        <option value="">-</option>
                                        <option value="1" <?php if ($marital == "1") {
                                                                echo ' selected';
                                                            } ?>>Single</option>
                                        <option value="2" <?php if ($marital == "2") {
                                                                echo ' selected';
                                                            } ?>>Married</option>
                                        <option value="3" <?php if ($marital == "3") {
                                                                echo ' selected';
                                                            } ?>>Divorced</option>
                                        <option value="4" <?php if ($marital == "4") {
                                                                echo ' selected';
                                                            } ?>>Widowed</option>
                                    </select>
                                </div>
                            ...
                            <div class="mt-2">
                                ...
                                <a href="../employee/emp_detail.php" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </div>
                    </form>
                    <!-- /Account -->
                    ...
                    <div class="card-body">
                        <div class="mb-3 col-12 mb-0"><br>
                            <div class="alert alert-warning">
                                <h6 class="alert-heading fw-bold mb-1">Are you sure you want to deactivate his/her account?</h6>
                                <p class="mb-0">Once you deactivate this account, there is no going back. Please be certain.</p>
                            </div>
                        </div>
                        <form method="post" action="../controller/ajax/del_function/del_employee.php">
                            <div class="form-check mb-3">
                                <input type="text" id="del_emp_id" name="del_emp_id" value="<?php echo $emp_code?>" hidden>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response != "0") {
                        ...
                        window.location.href = "emp_pers_detail.php?emp_id=" + response;
                    } else {
                        alert('update failed');
                    }
                },
