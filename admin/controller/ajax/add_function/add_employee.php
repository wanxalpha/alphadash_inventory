...
/*profile pic Location */
$location = "../../../../user/upload/profile/".$profile_name;
$imageFileType = pathinfo($location,PATHINFO_EXTENSION);
$imageFileType = strtolower($imageFileType);
...
$sql = "INSERT INTO employees (f_emp_id, f_full_name, f_emp_status, f_contact, f_home_tel, f_address, f_cor_address, f_email, f_birth_date, f_gender, f_country, f_identity, f_identity_img, f_race, f_religion, f_permit_from, f_permit_to, f_marital, f_spouse, f_children, f_ec1_name, f_ec1_relationship, f_ec1_contact, f_ec2_name, f_ec2_relationship, f_ec2_contact, f_picture, f_permit_picture, f_resume, f_com_email, f_mobile_all, f_park_all, f_department, f_designation, f_password, f_join_date, f_user_level, f_created_date, f_modified_date) VALUES ('$emp_id', '$fullname', '$emp_status', '$phone', '$home_tel', '$address', '$cor_address', '$email', '$birthday', '$gender', '$country', '$identity', '$personal_name', '$race2', '$religion2', '$permit_from', '$permit_to', '$marital', '$spouse', '$children', '$ec1_name', '$ec1_relationship', '$ec1_contact', '$ec2_name', '$ec2_relationship', '$ec2_contact', '$profile_name', '$permit_name', '$resume_name', '$com_email', '$mobile_all', '$park_all', '$department', '$designation', '$password', '$join_date', '$user_level', '$now', '$now')";
// echo $sql . "<br>";
...
$sql2 = "INSERT INTO bank_slip (f_emp_id, f_bank, f_bank_branch, f_bank_acc, f_salary, f_epf, f_epf_num, f_socso, f_socso_num, f_tax, f_eis, f_eis_num, f_created_date, f_modified_date) VALUES('$emp_id', '$bank', '$bank_branch', '$bank_acc', '$salary', '$epf_no', '$epf_amt', '$socso_no', '$socso_amt','$lhdn_no', '$eis_no', '$eis_amt', '$now', '$now')";
