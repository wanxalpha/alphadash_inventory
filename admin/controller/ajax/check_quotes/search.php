...
$sql = "SELECT a.f_id, a.f_quotes, b.f_first_name, b.f_last_name, a.f_delete, a.f_created_date FROM quotes a LEFT JOIN employees b ON a.f_emp_id=b.f_emp_id WHERE a.f_delete!='Y'";
...
if ($nums > 0) {
    ...
    while ($rows = mysqli_fetch_array($result)) {
        ...
        $out = strlen($quotes) > 10 ? substr($quotes,0,10)."..." : $quotes;
