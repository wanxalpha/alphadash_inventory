        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div class="row mb-2">
                <div class="col-sm-12">
                  <h6 class="card-header2" style="text-align: left;">New Member</h6>
                  <hr>
                  <div class="mb-3 row">
                    <label for="html5-text-input" class="col-md-2 col-form-label">Department</label>
                    <div class="col-md-3">
                      <select name="departments" id="departments" class="form-control form-control-sm select2" onchange="dep1()">
                    ...
                    <label for="html5-text-input" class="col-md-2 col-form-label">Staff Name</label>
                    <div class="col-md-3">
                      <select name="team" id="teamMember" class="form-control form-control-sm select2">
                        <option value="0"></option>
                      </select>
                    </div>
                    <div class="col-md-2" style="text-align: right;"><input type="button" id="addMember" class="btn btn-success btn-sm" value="Add member"></div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <h6 class="card-header2" style="text-align: left;">Designation</h6>
                  <hr>
                  <div class="mb-3 row">
                    <label for="html5-text-input" class="col-md-2 col-form-label">Member</label>
                    <div class="col-md-3">
                      <select name="departas" id="departas" class="form-control form-control-sm select2">
                        <option value="0"></option>
                        <?php
                        ...
                        ?>
                            <option value="<?php echo $rowMember['f_bil'] ?>"><?php echo $rowMember['l_name'] ?></option>
                        <?php
                          }
                        }
                        ?>
                    ...
                    <div class="col-md-3">
                      <select name="teampa" id="teampa" class="form-control form-control-sm select2">
                        <option value="0"></option>
                    ...
                    <div class="col-md-2" style="text-align: right;"><input type="button" id="saverole" class="btn btn-success btn-sm" value="Save"></div>
                  </div>
                        ...
                        <tbody>
                          ...
                          ?>
                              <tr>
                                ...
                                <td><?php echo $rowDes['l_name'] ?></td>
                                <td><?php echo $rowDes['f_designation'] ?></td>
                                <td><?php echo $rowDes['f_department'] ?></td>
                                <td><a type="button" href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?php echo $rowDes['f_bil'] ?>">Edit Role</a></td>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <form>
                                            ...
                                            <!-- <ul>
                                              <li> -->
                                                <div class="form-group row">
                                                  <input class="form-control form-control-sm" type="text" id="exampleFormControlReadOnlyInput1" placeholder="<?php echo $rowDes['l_name'] ?>" readonly />
                                                </div>
                                                <br />
                                                <div class="form-group row">
                                                  <select name="teampa1<?php echo $rowDes['f_bil'] ?>" id="teampa1<?php echo $rowDes['f_bil'] ?>" class="form-control form-control-sm select2">
                                                      <option value="0"><?php echo $rowDes['f_designation'] ?></option>
                                                      <option value="1">PROJECT MANAGER</option>
                                                      <option value="2">TEAM</option>
                                                      <option value="3">MANAGEMENT</option>
                                                      <option value="4">SALES</option>
                                        ...
                                        <div class="modal-footer">
                                          <button type="button" onclick="editRole<?php echo $rowDes['f_bil'] ?>()" class="btn btn-primary btn-sm">Save</button>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div class="row mb-2">
                <div class="col-sm-12">
                  <h5 class="card-header2" style="text-align: left;">Upload Data</h5>
                  <hr>
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          <div class="row">
                            <div class="col-md-3">
                              <center><a href="form_sample.csv">--download sample form--</a></center>
                            </div>
                            <div class="col-md-6">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div class="row mb-2">
                <div class="col-sm-12">
                  <h5 class="card-header2" style="text-align: left;">Upload Project</h5>
                  <hr>
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                            ...
                            <div class="col-lg-12">
                              <div class="row">
                                <div class="col-md-5">
                                  ...
                                  <div class="row">
                                    <div class="col-md-12">
                                      <textarea class="form-control" name="cAddress" id="cAddress" rows="5"></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-md-7">
                    ...
                    <div class="col-12">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <center><a href="form_sample_project.csv">--download sample form project--</a></center>
                            </div>
                            <div class="col-md-6">
                              <div class="input-group">
                                <div class="custom-file">
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div class="row mb-2">
                <div class="col-sm-12">
                  <h5 class="card-header2" style="text-align: left;">Product Services</h5>
                  <hr>
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="row">
                                ...
                                <div class="col-md-12"><textarea class="form-control" name="proDetail" id="proDetail" rows="4"></textarea></div>
                              </div>
                            </div>
                          </div>
                          <div class="row">
