    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" enctype="multipart/form-data" id="add_emp_form" action="../controller/ajax/add_function/add_employee.php">
                    <div class="row mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="emailExLarge" class="form-label">Bank Account<span class="text-danger">*</span></label>
                            <input name="bank_acc" id="bank_acc" class="form-control" type="text" required>
                        </div>
                        <div class="col-md-4 mb-4">
                            <label for="emailExLarge" class="form-label">Bank Name<span class="text-danger">*</span></label>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody class="table-border-bottom-0" id="company_table">
                                    <tr>
                                        ...
                                        <td><input type="text" id="old_salary1" name="old_salary1" class="form-control" placeholder="" value=""></td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4 mb-0">
                            <label for="emailExLarge" class="form-label">Salary<span class="text-danger">*</span></label>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 mb-0">
                            <label for="emailExLarge" class="form-label">Mobile Allowance<span class="text-danger">*</span></label>
                            <input name="mobile_all" id="mobile_all" required class="form-control" type="number">
                        </div>
                        <div class="col-md-4 mb-0">
                            <label for="emailExLarge" class="form-label">Parking Allowance<span class="text-danger">*</span></label>
                            <input name="park_all" id="park_all" required class="form-control" type="number">
                        </div>
                        <div class="col-md-4 mb-0">
                            <label for="emailExLarge" class="form-label">Employment Status<span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <label for="emailExLarge" class="form-label">Department<span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4 mb-4">
                            <label for="emailExLarge" class="form-label">Designation<span class="text-danger">*</span></label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="submitbutton" class="btn btn-primary submit-btn" onclick="check_background()">Save</button>
                <button type="submit" name="add_employee" id="add_emp_button" class="btn btn-primary submit-btn" style="display:none;">Save</button>
...
<script>
    function add_company() {
        ...
        if (i <= 3) {
            ...
            html += '<td><input type="text" id="old_salary' + i + '" name="old_salary' + i + '" class="form-control" placeholder="" value=""></td>';
            html += '</tr>';
    ...
    function check_id(){
        ...
        var url = "../controller/ajax/employee/check_id.php";
