<div id="edit_leave" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			...
			<img id="previewImg" src="blank_profile.png" alt="Placeholder" style="height:150px; width:150px; text-align:right; margin-top:13%; margin-left:60%; z-index:1000; position:absolute;">
					...
					<div class="row">
						...
						<div class="col-md-3 m-t-30 m-l-100">
							<table>
								<tr>
									<td width="30px">
										<input name="edit_half_day" id="half_day2" class="form-control" style="height:30px" value="off" type="checkbox" onclick="return false">
									</td>
									<td>
										&nbsp;&nbsp;&nbsp;Half Day
									</td>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input class="form-control upload" id="update_leave_image" name="edit_picture_image" type="file" onchange="loadFile(event)">
							</div>
						</div>
					</div>
					<div class="form-group">
