<?php 
    ...
    function getKPISalesTeam(){
        ...
        $sql_team_grouping = "SELECT * from sales_grouping where status = $status";
    ...
    function Calendar(){
        ...
        $role = $_SESSION['role'] == 'User' ? ' WHERE a.employee_id='.$_SESSION['emp_id'] : null;


        $sql = "SELECT a.id , a.company_name, a.appointment_date, b.f_first_name,b.f_last_name 
                FROM sales_appointment a LEFT JOIN employees b ON a.employee_id = b.f_id $role";
