...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    <h5 class="card-header2">Update Sales Funnel</h5>
                    <div class="card-body">

                        <form class="repeater" method="POST" action="../../controller/sales_funnel.php"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input class="form-control" type="date" name="project_dateline"
                                        id="project_dateline" value="<?php echo $row['project_dateline'] ?>" required />
                                </div>
                                <div class="mb-3 col-md-3">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <select name="Category" id="Category" class="select2 form-select" required>
                                            ...
                                            <?php foreach(getProjectCategory() as $category) { ?>
                                            <option value="<?php echo $category['id'] ?>" <?php if($category['id'] == $row['Category']) echo 'selected' ?>> <?php echo $category['Name'] ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                            ...
                            <div class="row div_remarks" style="<?php if($row['status'] == FunnelStatus::POTENTIAL) echo 'display: none;' ?>">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input class="form-control" type="text" id="company_name" name="company_name"
                                        value="<?php echo $row['company_name'] ?>" autofocus required />
                                </div>
                                <div class="mb-3 col-md-3">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input class="form-control" type="number" name="customer_contact"
                                        id="customer_contact" value="<?php echo $row['customer_contact'] ?>" required />
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input class="form-control" type="email" id="customer_email" name="customer_email"
                                        value="<?php echo $row['customer_email'] ?>" autofocus required />
                                </div>
                                <div class="mb-3 col-md-3">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <input class="form-control" type="date" name="project_po_date" id="project_po_date"
                                        value="<?php echo $row['project_po_date'] ?>" required />
                                </div>
                                    ...
                                    <div class="form-check form-check-inline mt-2">
                                        <div class="form-check form-check-inline mt-2">
                                            <input class="form-check-input" type="checkbox" name="project_pillar[]"
                                                id="inlineCheckbox<?php echo $row_pillar['project_code'] ?>" value="<?php echo $row_pillar['project_code'] ?>"
                                                <?php if(in_array($row_pillar['project_code'],json_decode($row['project_pillar'])))  echo 'checked'?> />
                                    ...
                                    <div data-repeater-list="document_list">
                                        <div data-repeater-item class="row">
                                            <div class="mb-3 col-lg-6">
                                                <input class="form-control" type="file" name="upload_document" value="" id="upload_document" required />
                                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <button type="submit" name="action" value="update"
                                    class="btn btn-primary me-2 float-right">Update</button>
                            </div>
                            <?php } ?>
                        </form>
                    </div>
