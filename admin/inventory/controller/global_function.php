...
$sql = "SELECT employees.f_first_name,employees.f_last_name,employees.f_emp_id,employees.f_designation,employees.f_picture,designations.f_position FROM employees
