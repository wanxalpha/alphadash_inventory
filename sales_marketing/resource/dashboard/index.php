...
<div class="modal fade" id="view_details" tabindex="-1" role="dialog" aria-labelledby="view_detailsLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">

            <div class="modal-body reset_form_btn">
                <form name="PesertaLuarForm" id="PesertaLuarForm" action="{{route('pk.permohonan.kursus.create')}}"
                    method="GET">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header text-white text-center"
                                    style="background:#646C9A;font-size:15px;">
                                    APPOINMENT DETAILS
                                </div>
                                <div class="card-body" style="background: #FFF8EA;">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" name="PendaftaranSiriKursusId"
                                                id="PendaftaranSiriKursusId" value="">
                                            <table class="table table-borderless" width="80%"
                                                id="table_details_kursus">
                                                <tbody>
                                                    <tr>
