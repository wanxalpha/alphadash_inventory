                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="../product_service/index.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-archive-in me-2"></i>
                    ...
                    <li class="menu-item">
                        <a href="../product_category/index.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-zoom-in me-2"></i>
                    ...
                    <li class="menu-item">
                        <a href="../sales_sector/index.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-anchor me-2"></i>
                            <div data-i18n="Documentation">Product Sector</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="../team_member/index.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-aperture me-2"></i>
